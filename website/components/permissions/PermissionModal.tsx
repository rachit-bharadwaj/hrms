...
import { LockKeyhole, FileText, X, Loader2, Code } from "lucide-react";
        ...
        <div className="px-6 py-5 border-b border-slate-50 flex items-center justify-between bg-slate-50/50">
          <div>
            ...
            <p className="text-xs text-slate-500 font-medium">
              Create granular access rules for the organization
            </p>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-100 rounded-xl text-sm font-mono focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 transition-all uppercase"
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              ...
              <textarea
                ...
                className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-100 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 transition-all resize-none"
