      ...
      <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in slide-in-from-bottom-4 duration-300">
        <div className="px-6 py-5 border-b border-slate-50 flex items-center justify-between bg-slate-50/50">
          <div>
            ...
            <p className="text-xs text-slate-500 font-medium">Create granular access rules for the organization</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-bold text-slate-400 uppercase tracking-wider ml-1">Permission Code</label>
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-mono focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 transition-all uppercase"
