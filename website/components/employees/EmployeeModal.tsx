        ...
        <div className="p-8 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <div>
            ...
            <p className="text-slate-500 text-sm font-medium">
              Complete organization profile and personal details.
            </p>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <select
                ...
                required
                className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-medium focus:ring-4 focus:ring-blue-500/5 focus:border-blue-500 transition-all"
              >
