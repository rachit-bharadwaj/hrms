        ...
        <div className="space-y-6">
          <div className="bg-primary rounded-[40px] p-8 text-white relative overflow-hidden">
            <div className="relative z-10">
              <div className="w-16 h-16 bg-white/10 rounded-xl flex items-center justify-center backdrop-blur-md mb-6">
                <User size={32} />
              </div>
              <h3 className="text-xl font-bold font-bricolage-grotesque">
                {employee?.firstName} {employee?.lastName}
              </h3>
              <p className="text-slate-500 text-sm font-black uppercase tracking-widest mt-1">
              ...
              <div className="mt-8 pt-8 border-t border-white/10 space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-bold font-bricolage-grotesque">
          ...
          <div className="bg-white p-8 rounded-[40px] border border-slate-100 shadow-xl shadow-slate-100/50 space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div
                  className={`w-10 h-5 rounded-full transition-all ${formData.pfApplicable ? "bg-emerald-500" : "bg-slate-200"}`}
                />
              </div>
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-slate-500">
                ...
                <div
                  className={`w-10 h-5 rounded-full transition-all ${formData.esiApplicable ? "bg-emerald-500" : "bg-slate-200"}`}
                />
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-2">
          ...
          >
            ...
            <div className="p-10 space-y-10">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold focus:ring-4 focus:ring-blue-500/5 outline-none"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-black text-slate-500 uppercase tracking-widest ml-1">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          otherEarnings: Number(e.target.value),
                        })
                      }
                      className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold focus:ring-4 focus:ring-blue-500/5 outline-none"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          tdsRatePercent: Number(e.target.value),
                        })
                      }
                      className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold focus:ring-4 focus:ring-blue-500/5 outline-none"
                    />
              ...
              <button
                type="submit"
                className="w-full py-5 bg-primary text-white rounded-[22px] text-sm font-bold hover:bg-primary/80 transition-all shadow-2xl shadow-slate-900/10 active:scale-95 flex items-center justify-center gap-2"
              >
                <Save size={18} />
