...
export default function PayslipDetailPage({ params }: { params: any }) {
  ...
  if (isLoading)
    return (
      <div className="p-20 text-center animate-pulse font-bold text-slate-500 uppercase tracking-widest">
        Generating Digital Payslip...
      </div>
    );
  if (!data)
    return (
      ...
      <div className="flex items-center justify-between no-print mb-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-primary text-white rounded-xl text-xs font-bold hover:bg-primary/80 transition-all active:scale-95 shadow-xl shadow-slate-900/10"
          >
            <Printer size={16} />
      ...
      <div className="bg-white rounded-[40px] border border-slate-100 shadow-2xl overflow-hidden print:shadow-none print:border-none print:m-0 print:p-8">
        ...
        <div className="p-10 border-b border-slate-50 flex flex-col md:flex-row justify-between items-start md:items-center gap-8 bg-slate-50/30">
          <div className="flex items-center gap-5">
            ...
            <div>
              <h2 className="text-2xl font-bold text-slate-900 font-bricolage-grotesque leading-tight">
                Harbor HRMS Platform
              </h2>
              <p className="text-slate-500 text-xs font-bold uppercase tracking-widest mt-1">
                Salary Slip for {monthNames[month - 1]} {year}
              </p>
            </div>
          </div>
          <div className="text-right">
            <span className="text-sm font-black text-blue-600 bg-blue-50 px-3 py-1 rounded-full uppercase tracking-wider mb-2 inline-block">
              Official Record
            </span>
            <h3 className="text-lg font-bold text-slate-900 font-bricolage-grotesque">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-10 bg-slate-50/10">
          ...
          <div className="bg-primary rounded-3xl p-6 text-white flex flex-col justify-center shadow-xl shadow-slate-900/10">
            <p className="text-sm font-black opacity-60 uppercase tracking-widest mb-1">
              Net Payable Amount
            </p>
            <p className="text-3xl font-bold font-bricolage-grotesque">
        ...
        <div className="p-10 space-y-10">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-slate-900 font-black">
                    ₹{payslip.pfEmployee.toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-slate-500 font-bold">Employee ESI</span>
                  <span className="text-slate-900 font-black">
                    ₹{payslip.esiEmployee.toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-slate-500 font-bold">
                ...
                {payslip.otherDeductions > 0 && (
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-slate-900 font-black">
                      ₹{payslip.otherDeductions.toLocaleString()}
                    </span>
                  </div>
                )}
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-3xl sm:text-5xl font-bold font-bricolage-grotesque">
                    ₹{payslip.netPay.toLocaleString()}
                  </p>
                </div>
              </div>
              <div className="p-8 border border-white/10 rounded-3xl bg-white/5 backdrop-blur-md text-center shrink-0 min-w-[240px]">
                <p className="text-sm font-black opacity-60 uppercase tracking-widest mb-2">
                ...
                <div className="flex justify-around items-center">
                  <div>
                    ...
                    <p className="text-sm font-black">
                      ₹{payslip.pfEmployer.toLocaleString()}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm font-black">
                      ₹{payslip.esiEmployer.toLocaleString()}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="pt-10 flex flex-col md:flex-row justify-between items-end gap-10 opacity-60">
            <div className="max-w-md">
              <h5 className="text-sm font-black text-slate-900 uppercase tracking-widest mb-2">
                Legal Disclaimer
              </h5>
              <p className="text-[9px] text-slate-500 leading-relaxed font-medium">
                This is a computer-generated document and does not require a
                physical signature. All amounts mentioned are in Indian Rupees
                (INR). For any queries, reach out to the payroll department
                within 5 working days of disbursement.
              </p>
            </div>
