    ...
    <div className="flex flex-col gap-8 w-full pb-20 p-4 md:p-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-slate-500 text-sm font-medium mt-1">
            Build and manage your organizational structure and team
            distribution.
          </p>
        </div>
        <button
          ...
          className="flex items-center justify-center gap-2 bg-primary hover:bg-primary/80 text-white px-8 py-4 rounded-xl text-sm font-bold transition-all shadow-xl shadow-slate-900/10 active:scale-95 whitespace-nowrap group"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          <div
            key={i}
            className="bg-white p-7 rounded-xl border border-slate-100 shadow-sm flex items-center justify-between group hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
          >
            <div>
              <p className="text-slate-500 mb-2">{stat.label}</p>
              <p
            ...
            <div
              className={`p-4 rounded-xl ${stat.bg} ${stat.color} group-hover:scale-110 transition-transform duration-300`}
            >
              <stat.icon size={24} />
            </div>
          </div>
      ...
      <div className="bg-white rounded-[40px] border border-slate-100 shadow-xl shadow-slate-200/20 overflow-hidden flex flex-col">
        ...
        <div className="p-8 border-b border-slate-50 flex flex-col md:flex-row items-center justify-between bg-slate-50/30 gap-6">
          <div className="relative w-full max-w-md group">
            ...
            <input
              ...
              className="w-full pl-14 pr-6 py-4 bg-white border-2 border-slate-100 rounded-[22px] text-sm font-semibold focus:outline-none focus:ring-4 focus:ring-blue-500/5 focus:border-blue-500 transition-all shadow-sm placeholder:text-slate-500 placeholder:font-medium"
            />
          </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse">
            <thead>
              <tr className="text-left text-[11px] font-bold text-slate-500 uppercase tracking-[0.15em] border-b border-slate-50 bg-slate-50/10">
                  ...
                  <td colSpan={5} className="px-10 py-32 text-center">
                    <div className="flex flex-col items-center gap-4">
                      ...
                      <p className="text-slate-500 text-sm max-w-xs">
                        Try adjusting your search or create a new department to
                        get started.
                      </p>
                    </div>
                  </td>
                  ...
                  >
                    <td className="pl-10 pr-6 py-7">
                      <div className="flex items-center gap-5">
                        <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-slate-900 to-slate-700 flex items-center justify-center shadow-lg shadow-slate-900/10 group-hover:rotate-3 transition-transform">
                          <Building2 size={24} className="text-white" />
                        </div>
                        <div className="flex flex-col">
                          <span className="text-lg font-bold text-slate-900 mb-0.5">
                            {dept.name}
                          </span>
                    ...
                    <td className="pl-6 pr-10 py-7 text-right">
                      <div className="flex items-center justify-end gap-3 opacity-0 group-hover:opacity-100 transition-opacity translate-x-4 group-hover:translate-x-0">
                        <Link
                          ...
                          className="p-3 bg-white hover:bg-emerald-50 rounded-xl text-slate-500 hover:text-emerald-600 border border-slate-100 hover:border-emerald-100 transition-all shadow-sm"
                          title="View Staff"
                        >
                          <Users size={18} />
                        </Link>
                        <button
                          ...
                          className="p-3 bg-white hover:bg-blue-50 rounded-xl text-slate-500 hover:text-blue-600 border border-slate-100 hover:border-blue-100 transition-all shadow-sm"
                        >
                          <Edit2 size={18} />
                        </button>
                        <button
                          onClick={() => handleDelete(dept.id)}
                          className="p-3 bg-white hover:bg-red-50 rounded-xl text-slate-500 hover:text-red-500 border border-slate-100 hover:border-red-100 transition-all shadow-sm"
                        >
                          <Trash2 size={18} />
                        </button>
                      </div>
