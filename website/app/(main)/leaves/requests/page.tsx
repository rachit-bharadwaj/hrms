      ...
      <div className="bg-white rounded-[40px] border border-slate-100 shadow-xl shadow-slate-200/20 overflow-hidden flex flex-col">
        <div className="p-8 border-b border-slate-50 flex flex-col md:flex-row items-center justify-between bg-slate-50/20 gap-6">
          ...
          <div className="flex items-center gap-3">
            <button className="flex items-center gap-2 px-6 py-4 bg-white border border-slate-200 rounded-xl text-sm font-bold text-slate-600 hover:bg-slate-50 transition-all">
              <Filter size={18} />
        ...
        <div className="divide-y divide-slate-50">
          {isLoading ? (
            ...
            <div className="p-24 text-center">
              ...
              <p className="text-slate-500 text-sm font-medium mt-1">
                No pending leave requests to review at the moment.
              </p>
            </div>
          ) : (
            requests.map((req: any) => (
              <div
                key={req.id}
                className="p-10 hover:bg-slate-50/30 transition-all group"
              >
                <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-10">
                  <div className="flex-1 flex gap-6">
                    <div className="w-14 h-14 rounded-xl bg-primary flex items-center justify-center text-white shadow-lg shadow-slate-900/10 shrink-0">
                      <User size={24} />
                    </div>
                    <div className="space-y-4">
                      <div>
                        <h4 className="text-xl font-bold text-slate-900 font-bricolage-grotesque">
                          {req.employeeName}
                        </h4>
                  ...
                  <div className="w-full lg:w-80 space-y-4">
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        className="w-full pl-12 pr-4 py-4 bg-white border border-slate-200 rounded-xl text-xs font-semibold focus:ring-4 focus:ring-blue-500/5 focus:border-blue-500 outline-none resize-none transition-all"
                        rows={2}
                      />
                    </div>
                    <div className="flex gap-3">
                      <button
                        ...
                        className="flex-1 py-4 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-[11px] font-black uppercase tracking-widest transition-all shadow-lg shadow-emerald-600/10 active:scale-95 flex items-center justify-center gap-2"
                      >
                      ...
                      <button
                        ...
                        className="flex-1 py-4 bg-red-600 hover:bg-red-700 text-white rounded-xl text-[11px] font-black uppercase tracking-widest transition-all shadow-lg shadow-red-600/10 active:scale-95 flex items-center justify-center gap-2"
                      >
                        <XCircle size={16} />
                        Reject
                      </button>
